...
INSERT INTO config_store (key, value, encrypted) VALUES ('quantinuum.token_expiry', 'null'::jsonb, false) ON CONFLICT (key) DO NOTHING;
INSERT INTO config_store (key, value, encrypted) VALUES ('quantinuum.device', '"H2-1"'::jsonb, false) ON CONFLICT (key) DO NOTHING;
